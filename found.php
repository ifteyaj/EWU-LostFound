    ...
    <div class="container" style="padding-top: 3rem; padding-bottom: 5rem;">
        ...
        <form action="" method="GET" class="section-header" style="margin-bottom: 2rem;">
            ...
            <div class="search-wrapper" style="margin:0; width:300px;">
                ...
                <?php if(isset($_GET['search']) && !empty($_GET['search'])): ?>
                    <a href="found.php" style="position:absolute; right:10px; top:50%; transform:translateY(-50%); color:var(--text-muted);">&times;</a>
                <?php endif; ?>
            </div>
        </form>
        ...
        <div class="items-grid">
            ...
            if ($conn && !$conn->connect_error) {
                // 1. Get Total Count
                $countSql = "SELECT COUNT(*) as total FROM found_items";
                $whereClause = "";
                $params = [];
                $types = "";
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='empty-state'><h3>No found items found matching your search.</h3></div>";
                }
                $stmt->close();
            } else {
